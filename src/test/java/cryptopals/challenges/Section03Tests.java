...
public class Section03Tests {
    ...
    public void challenge17() {
        ...
        var ivecAndEncPair = oracle.selectRandomStringAndEncrypt();
        var ivec = ivecAndEncPair.getLeft();
        var encrypted = ivecAndEncPair.getRight();
        ...
        String candidate = new String(Section02.stripPCKS7Padding(decrypted));

        //see what we got
        assertTrue(oracle.stringIsPresentInHiddenPlainTexts(candidate));
    }
}
