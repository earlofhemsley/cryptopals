...
public class Challenge12Tool {
    ...
    public byte[] breakECBEncryption(byte[] unknownInput) throws IllegalBlockSizeException, NoSuchPaddingException, BadPaddingException, NoSuchAlgorithmException, InvalidKeyException, DecoderException {
        ...
        for (int i = 2; i<=128; i+=2) {
            ...
            oracleResult = ecb.AESinEBCModeWConcatenation(hackerInput, unknownInput);
        ...
        for (int i = 0; i < 256; i++) {
            ...
            var result = ecb.AESinEBCModeWConcatenation(hackerInput, new byte[0]);
        ...
        for (int i = 0; i<unknownInput.length; i++) {
            ...
            //encrypt
            var encrypted = ecb.AESinEBCModeWConcatenation(hackerInput, new byte[0]);
